...
class Constants:
    ...
    CMSG_AUTH                           = 101
    CMSG_DISCONNECT                     = 102
    CMSG_GO_TO_CHARACTER_SELECTION      = 103
    CMSG_SELECT_CHARACTER               = 104
    CMSG_REGISTER                       = 105
    CMSG_CREATE_CHARACTER               = 106
    CMSG_CHAT                           = 111
    CMSG_MOVE                           = 110
#     CMSG_ATTACK                         = 107
#     CMSG_HEALTH                         = 108
...
#     CMSG_CONTROL_POINT_CAP              = 112
    ...
    SMSG_AUTH                           = 201
    SMSG_DISCONNECT                     = 202
    SMSG_GO_TO_CHARACTER_SELECTION      = 203
    SMSG_SELECT_CHARACTER               = 204
    SMSG_REGISTER                       = 205
    SMSG_CREATE_CHARACTER               = 206
    SMSG_MOVE                           = 210
    SMSG_CHAT                           = 211
    SMSG_PLAYER_LOGOUT                  = 212
    SMSG_SPAWN                          = 213
#     SMSG_ATTACK                         = 207
#     SMSG_HEALTH                         = 208
#     SMSG_RESOURCE                       = 209
